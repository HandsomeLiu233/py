...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.Command1 = Button(self.top, text='华为手机', textvariable=self.Command1Var, command=self.Command1_Cmd,
                               font=self.Command1Font)
        ...
        self.Command2 = Button(self.top, text='苹果手机', textvariable=self.Command2Var, command=self.Command2_Cmd,
                               font=self.Command2Font)
